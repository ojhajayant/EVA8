#!/usr/bin/env python
"""
model.py: This contains different possible CNN class definitions.
"""
...
# model used with CIFAR10 dataset


# dropout_value = 0.029 # Need proper changes in overall structure to
# accommodate these different custom values found for different custom models
# for example this commented value worked quite good for the MNIST model used
# during session 4 & 5.
