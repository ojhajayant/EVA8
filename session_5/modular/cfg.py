...
parser = argparse.ArgumentParser(
    description='Training and Validation on MNIST Dataset')
...
parser.add_argument('--cuda', default=torch.cuda.is_available(), type=bool,
                    help='use gpu or not')
parser.add_argument('--dropout', '-d', default=0.029, type=float,
                    help='dropout percentage for all layers')
parser.add_argument('--normalization', '-n', default='batch',
                    choices=['batch', 'layer', 'group'], type=str,
                    help='Type of Normalization used for each layer '
                         'Batch/Layer/Group')
